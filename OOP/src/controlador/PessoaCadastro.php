...
// instância um objeto do tipo Pessoa e passa como parâmtro para a função construtora da classe
// os valores dos atributos de requisição atráves do método post (nome e cpf).

$pessoaDAO = new PessoaDAO(); 
// Instância uma classe do tipo PessoaDAO. Esta classe executa todas as operações no banco de dados
...
$pessoaDAO->inserirObjeto($pessoa); 
// é invocado a função "inserirPessoa que recebe um objeto do tipo Pessoa como parâmetro".
